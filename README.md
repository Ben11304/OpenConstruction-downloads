...
[Download OpenConstruction 0.3.2 Preview 7 for Apple Silicon](https://github.com/Ben11304/OpenConstruction-downloads/releases/download/v0.3.2-preview.7/OpenConstruction-0.3.2-preview.7-mac-arm64.dmg)

Preview 7 shows live agent progress and streams answer text during research runs. It also includes the Preview 5 launch fix.
...
[View release notes and checksum](https://github.com/Ben11304/OpenConstruction-downloads/releases/tag/v0.3.2-preview.7)
